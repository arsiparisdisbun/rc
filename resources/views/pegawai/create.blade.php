@extends('layouts.app')
@section('judul', 'Tambah Pegawai - siarsip')
        ...
        <div class="card-body">
            <form action="{{ route('pegawai.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="tanggal_status" class="form-control" value="{{ old('tanggal_status') }}">
                ...
                <div class="d-flex gap-2">
                    ...
                    <button type="submit" class="btn btn-primary flex-grow-1">Simpan Data Pegawai</button>
                </div>
            </form>
        </div>
    </div>
